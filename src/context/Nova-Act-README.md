# Note: This is a copy of the main Nova Act Readme (https://github.com/aws/nova-act). Adding it to the project to make it easier to add to the context for LLM tools while building this.
